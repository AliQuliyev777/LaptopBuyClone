...
// const LaptopPagerightside = () => {

//     return (
//         <>
//             <div className="LaptopPagerightside_right_side_">
//                 <h1>Chimera NP7861D Gaming Laptop</h1>
...
//                         </div>
//                         <div className="LaptopPagerightsideSpecifationoptiontext">
//                             <span>Chimera NP7861D, 15.6'' Full HD 1920x1080, 144Hz, Wide View Angle, Matte Finish</span>
//                         </div>
//                     </div>
//                     <div className="LaptopPagerightsideSpecifationoption">
//                         <div className="LaptopPagerightsideSpecifationoptionimg">
...
//                         </div>
//                         <div className="LaptopPagerightsideSpecifationoptiontext">
//                             <span>Intel® Core™ i9-13900HX Processor (8X P-core + 16X E-core, up to 5.5GHz/36MB L3 Cache)</span>
//                         </div>
//                     </div>
//                     <div className="LaptopPagerightsideSpecifationoption">
//                         <div className="LaptopPagerightsideSpecifationoptionimg">
...
//                         </div>
//                         <div className="LaptopPagerightsideSpecifationoptiontext">
//                             <span>16GB [16GB x 1] 5600MHz DDR5 SO-DIMM Laptop Memory</span>
//                         </div>
//                     </div>
//                     <div className="LaptopPagerightsideSpecifationoption">
//                         <div className="LaptopPagerightsideSpecifationoptionimg">
...
//                         </div>
//                         <div className="LaptopPagerightsideSpecifationoptiontext">
//                             <span>NVIDIA GeForce RTX 4060 - 8 GB GDDR6 (DLSS 3.0 – AI-Powered Performance) [NB]</span>
//                         </div>
//                     </div>
//                     <div className="LaptopPagerightsideSpecifationoption">
//                         <div className="LaptopPagerightsideSpecifationoptionimg">
...
//                         </div>
//                         <div className="LaptopPagerightsideSpecifationoptiontext">
//                             <span>1TB WD Blue SN580 M.2 PCIe Gen 4 NVMe SSD -- Gen 4 Read: 4150MB/s; Write: 4150MB/s, Gen 3 Read: 3539MB/s; Write: 3444MB/s</span>
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
// export default LaptopPagerightside;
