...
const CardviewEmpty = () => {
    return (
        <div className="md:text-text-sm w-autotext-xs md:w-3/5 sepetcolor">
        <div className="empty-cart">
            ...
            <Link className="showFullSpecClick121212" to="/laptopsviewall" ><span>  Continue shopping</span></Link>
